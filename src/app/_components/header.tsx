  ...
  return (
    <header className="absolute inset-x-0 top-0 z-40">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-primary px-6 py-6 text-primary-foreground sm:max-w-sm sm:ring-1 sm:ring-gold">
